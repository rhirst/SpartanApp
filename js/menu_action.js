var menus = [[['Shaw Hall Breakfast: 7-11 am', 'Bread Box', 'Scrambled Eggs', 'Bacon', 'Hash Browns', 'Pancakes', 'Grits'],['Shaw Hall Lunch: 11am-2pm','Main Street', 'Carved Sirloin Roast', 'Seasoned Sour Cream', 'Mashed Potatoes', 'Buffalo Chicken Melt'],['Shaw Hall Dinner: 5-8pm', 'Garden Wok', 'Baked Artichokes', 'Whole Wheat Penne', 'Italian Breadsticks', 'Pot Stickers'],['Shaw Hall Late Night Not Available', '']],
					[['Case Hall Breakfast: 7-10 am', 'Great Lakes Plate', 'Scrambled Eggs', 'Omelets to Order', 'Baked Oatmeal', 'Cheddar Sausage'],['Case Hall Lunch: 11-2pm', 'Ciao!', 'Pepperoni Pizza', 'Cheese Pizza', 'Quatro Formaggio Pizza', 'Specialty Sandwiches'],['Case Hall Dinner 5-8pm', 'Brimstone Grille', 'Grilled Chicken', 'Chicken Patty Sandwich', 'Golden French Fries'], ['Case Hall Late Night Not Available', '']],
